Kebijakan Privasi
TVRI Nasional membangun Aplikasi TVRI Citizen Journalism sebagai aplikasi Gratis. Layanan ini disediakan oleh TVRI Nasional tanpa biaya untuk digunakan untuk TVRI National dan untuk digunakan apa adanya.
...
Istilah yang digunakan dalam Kebijakan Privasi ini memiliki arti yang sama seperti dalam Syarat dan Ketentuan kami, yang dapat diakses di TVRI.go.id kecuali ditentukan lain dalam Kebijakan Privasi ini.

Pengumpulan dan Penggunaan Informasi
Untuk pengalaman yang lebih baik, saat menggunakan Layanan kami, kami mungkin meminta Anda untuk memberikan kami informasi pengenal pribadi tertentu, termasuk namun tidak terbatas pada email. Informasi yang kami minta akan disimpan oleh kami dan digunakan seperti yang dijelaskan dalam kebijakan privasi ini.
...
Kontak Kami
Jika Anda memiliki pertanyaan atau saran tentang Kebijakan Privasi kami, jangan ragu untuk menghubungi kami di ejournaltvri@gmail.com.
